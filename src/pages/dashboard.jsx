      ...
      <div className="dashboard">
        <div className="dashboard-header d-flex justify-content-between align-items-center">
            ...
            <div className="search flex w-100 ">
                <input type="text" placeholder="Search docID, name, etc..." className='form form-control w-75 bg-secondary mx-2' />
                <FaSearch/>
            </div>
        </div>
        <div className="dashboard-content mx-3 mt-3">
            <h4 className="my-3">Compliances & Completed Documents</h4>
             <ListGroup horizontal>
                <ListGroup.Item>All <Badge bg="info">9</Badge></ListGroup.Item>
                <ListGroup.Item>Pending <Badge bg="info">9</Badge></ListGroup.Item>
                <ListGroup.Item>Recieved <Badge bg="info">9</Badge></ListGroup.Item>
            ...
            <tbody>
                <tr>
                    ...
                    <td>Oct. 27, 2023</td>
                    <td><Badge bg="warning" className="text-black">Pending</Badge></td>
                    <td className="flex"><img src="./assets/images/pepicons-pencil_dots-y.png" alt="" /></td>
